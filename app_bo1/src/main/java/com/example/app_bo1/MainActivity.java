...
import static com.example.app_bo1.R.layout.row;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameDB gameDB = new GameDB(context,"game.db",null,1);
...
//
    ...
    public void play() {
        ...
        adapter = new SimpleAdapter(context, list, row, new String[]{num>=5?"image":"image2"}, new int[]{R.id.imageView});
    ...
    public void onClick2(View view) {
        ...
        Cursor cursor = db.rawQuery("SELECT _id, name, number, strftime('%Y/%m/%d %H:%M:%S', time) as 'time' FROM game", null);
